...
final class LibraryTableView: UITableView {
  ...
  init() {
    ...
    self.register(LibraryCell.self, forCellReuseIdentifier: LibraryCell.reuseIdentifier)
    register(LibraryAddBookCell.self, forCellReuseIdentifier: LibraryAddBookCell.reuseIdentifier)
    self.rowHeight = LibraryCell.rowHeigh
...
extension LibraryTableView: UITableViewDataSource, UITableViewDelegate {
